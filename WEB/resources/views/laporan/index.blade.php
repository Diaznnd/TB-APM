...
<div class="glass-card p-10 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800">
    <h2 class="text-2xl font-bold text-slate-900 dark:text-white mb-4">Halaman Laporan</h2>
    <p class="text-slate-500 dark:text-slate-400">Selamat datang di modul Laporan. Analisis performa bisnis Anda melalui berbagai laporan statistik.</p>
    ...
    <div class="mt-8 p-12 border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-2xl flex flex-col items-center justify-center text-center">
        ...
        <p class="text-slate-400 font-medium text-sm">Konten laporan akan ditambahkan di sini.</p>
    </div>
</div>
@endsection
